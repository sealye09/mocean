...
export const MCPAssistantServerFindFirstOrThrowSelectSchema: z.ZodType<Prisma.MCPAssistantServerSelect> = z.object({
...
export const MCPAssistantServerFindFirstOrThrowSelectZodSchema = z.object({
    assistant: z.boolean().optional(),
    assistantId: z.boolean().optional(),
    mcpServer: z.boolean().optional(),
    mcpServerId: z.boolean().optional()
