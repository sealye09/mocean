...
export const MCPServerFindManySelectSchema: z.ZodType<Prisma.MCPServerSelect> = z.object({
...
export const MCPServerFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    type: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const MCPServerFindManySchema: z.ZodType<Prisma.MCPServerFindManyArgs> = z.object({ select: MCPServerFindManySelectSchema.optional(), include: z.lazy(() => MCPServerIncludeObjectSchema.optional()), orderBy: z.union([MCPServerOrderByWithRelationInputObjectSchema, MCPServerOrderByWithRelationInputObjectSchema.array()]).optional(), where: MCPServerWhereInputObjectSchema.optional(), cursor: MCPServerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MCPServerScalarFieldEnumSchema, MCPServerScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.MCPServerFindManyArgs>;

export const MCPServerFindManyZodSchema = z.object({ select: MCPServerFindManySelectSchema.optional(), include: z.lazy(() => MCPServerIncludeObjectSchema.optional()), orderBy: z.union([MCPServerOrderByWithRelationInputObjectSchema, MCPServerOrderByWithRelationInputObjectSchema.array()]).optional(), where: MCPServerWhereInputObjectSchema.optional(), cursor: MCPServerWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([MCPServerScalarFieldEnumSchema, MCPServerScalarFieldEnumSchema.array()]).optional() }).strict();