...
export const ModelProviderFindManySelectSchema: z.ZodType<Prisma.ModelProviderSelect> = z.object({
...
export const ModelProviderFindManySelectZodSchema = z.object({
    model: z.boolean().optional(),
    modelId: z.boolean().optional(),
    provider: z.boolean().optional(),
    providerId: z.boolean().optional(),
...
export const ModelProviderFindManySchema: z.ZodType<Prisma.ModelProviderFindManyArgs> = z.object({ select: ModelProviderFindManySelectSchema.optional(), include: z.lazy(() => ModelProviderIncludeObjectSchema.optional()), orderBy: z.union([ModelProviderOrderByWithRelationInputObjectSchema, ModelProviderOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelProviderWhereInputObjectSchema.optional(), cursor: ModelProviderWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelProviderScalarFieldEnumSchema, ModelProviderScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ModelProviderFindManyArgs>;

export const ModelProviderFindManyZodSchema = z.object({ select: ModelProviderFindManySelectSchema.optional(), include: z.lazy(() => ModelProviderIncludeObjectSchema.optional()), orderBy: z.union([ModelProviderOrderByWithRelationInputObjectSchema, ModelProviderOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelProviderWhereInputObjectSchema.optional(), cursor: ModelProviderWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelProviderScalarFieldEnumSchema, ModelProviderScalarFieldEnumSchema.array()]).optional() }).strict();