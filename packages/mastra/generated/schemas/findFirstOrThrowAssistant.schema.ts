...
export const AssistantFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AssistantSelect> = z.object({
...
export const AssistantFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    prompt: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const AssistantFindFirstOrThrowSchema: z.ZodType<Prisma.AssistantFindFirstOrThrowArgs> = z.object({ select: AssistantFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AssistantIncludeObjectSchema.optional()), orderBy: z.union([AssistantOrderByWithRelationInputObjectSchema, AssistantOrderByWithRelationInputObjectSchema.array()]).optional(), where: AssistantWhereInputObjectSchema.optional(), cursor: AssistantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AssistantScalarFieldEnumSchema, AssistantScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AssistantFindFirstOrThrowArgs>;

export const AssistantFindFirstOrThrowZodSchema = z.object({ select: AssistantFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AssistantIncludeObjectSchema.optional()), orderBy: z.union([AssistantOrderByWithRelationInputObjectSchema, AssistantOrderByWithRelationInputObjectSchema.array()]).optional(), where: AssistantWhereInputObjectSchema.optional(), cursor: AssistantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AssistantScalarFieldEnumSchema, AssistantScalarFieldEnumSchema.array()]).optional() }).strict();