...
export const AssistantCountOutputTypeCountKnowledgeBasesArgsObjectSchema = makeSchema();
export const AssistantCountOutputTypeCountKnowledgeBasesArgsObjectZodSchema = makeSchema();
