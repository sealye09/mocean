...
export const ModelCountOutputTypeCountKnowledgeBasesArgsObjectSchema = makeSchema();
export const ModelCountOutputTypeCountKnowledgeBasesArgsObjectZodSchema = makeSchema();
