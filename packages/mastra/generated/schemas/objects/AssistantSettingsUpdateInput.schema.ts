...
import { AssistantUpdateOneWithoutSettingsNestedInputObjectSchema as AssistantUpdateOneWithoutSettingsNestedInputObjectSchema } from './AssistantUpdateOneWithoutSettingsNestedInput.schema';
import { AgentUpdateOneWithoutSettingsNestedInputObjectSchema as AgentUpdateOneWithoutSettingsNestedInputObjectSchema } from './AgentUpdateOneWithoutSettingsNestedInput.schema';
import { ModelUpdateOneWithoutAssistantSettingsNestedInputObjectSchema as ModelUpdateOneWithoutAssistantSettingsNestedInputObjectSchema } from './ModelUpdateOneWithoutAssistantSettingsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  assistant: z.lazy(() => AssistantUpdateOneWithoutSettingsNestedInputObjectSchema).optional(),
  agent: z.lazy(() => AgentUpdateOneWithoutSettingsNestedInputObjectSchema).optional(),
  defaultModel: z.lazy(() => ModelUpdateOneWithoutAssistantSettingsNestedInputObjectSchema).optional()
}).strict();
export const AssistantSettingsUpdateInputObjectSchema: z.ZodType<Prisma.AssistantSettingsUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.AssistantSettingsUpdateInput>;
export const AssistantSettingsUpdateInputObjectZodSchema = makeSchema();
