...
export const AgentCountOutputTypeCountKnowledgeBasesArgsObjectSchema = makeSchema();
export const AgentCountOutputTypeCountKnowledgeBasesArgsObjectZodSchema = makeSchema();
