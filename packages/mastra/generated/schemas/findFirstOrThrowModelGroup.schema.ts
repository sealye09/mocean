...
export const ModelGroupFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ModelGroupSelect> = z.object({
...
export const ModelGroupFindFirstOrThrowSelectZodSchema = z.object({
    model: z.boolean().optional(),
    modelId: z.boolean().optional(),
    group: z.boolean().optional(),
    groupId: z.boolean().optional(),
...
export const ModelGroupFindFirstOrThrowSchema: z.ZodType<Prisma.ModelGroupFindFirstOrThrowArgs> = z.object({ select: ModelGroupFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ModelGroupIncludeObjectSchema.optional()), orderBy: z.union([ModelGroupOrderByWithRelationInputObjectSchema, ModelGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelGroupWhereInputObjectSchema.optional(), cursor: ModelGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelGroupScalarFieldEnumSchema, ModelGroupScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ModelGroupFindFirstOrThrowArgs>;

export const ModelGroupFindFirstOrThrowZodSchema = z.object({ select: ModelGroupFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ModelGroupIncludeObjectSchema.optional()), orderBy: z.union([ModelGroupOrderByWithRelationInputObjectSchema, ModelGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelGroupWhereInputObjectSchema.optional(), cursor: ModelGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelGroupScalarFieldEnumSchema, ModelGroupScalarFieldEnumSchema.array()]).optional() }).strict();