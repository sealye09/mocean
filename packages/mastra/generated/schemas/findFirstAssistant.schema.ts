...
export const AssistantFindFirstSelectSchema: z.ZodType<Prisma.AssistantSelect> = z.object({
...
export const AssistantFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    prompt: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const AssistantFindFirstSchema: z.ZodType<Prisma.AssistantFindFirstArgs> = z.object({ select: AssistantFindFirstSelectSchema.optional(), include: z.lazy(() => AssistantIncludeObjectSchema.optional()), orderBy: z.union([AssistantOrderByWithRelationInputObjectSchema, AssistantOrderByWithRelationInputObjectSchema.array()]).optional(), where: AssistantWhereInputObjectSchema.optional(), cursor: AssistantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AssistantScalarFieldEnumSchema, AssistantScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AssistantFindFirstArgs>;

export const AssistantFindFirstZodSchema = z.object({ select: AssistantFindFirstSelectSchema.optional(), include: z.lazy(() => AssistantIncludeObjectSchema.optional()), orderBy: z.union([AssistantOrderByWithRelationInputObjectSchema, AssistantOrderByWithRelationInputObjectSchema.array()]).optional(), where: AssistantWhereInputObjectSchema.optional(), cursor: AssistantWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AssistantScalarFieldEnumSchema, AssistantScalarFieldEnumSchema.array()]).optional() }).strict();