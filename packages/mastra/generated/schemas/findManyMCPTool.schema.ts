...
export const MCPToolFindManySelectSchema: z.ZodType<Prisma.MCPToolSelect> = z.object({
...
export const MCPToolFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
    inputSchema: z.boolean().optional(),
