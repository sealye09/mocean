...
export const AssistantSettingsFindManySelectSchema: z.ZodType<Prisma.AssistantSettingsSelect> = z.object({
...
export const AssistantSettingsFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    contextCount: z.boolean().optional(),
    temperature: z.boolean().optional(),
    topP: z.boolean().optional(),
