...
export const AgentFindFirstSelectSchema: z.ZodType<Prisma.AgentSelect> = z.object({
...
export const AgentFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    prompt: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const AgentFindFirstSchema: z.ZodType<Prisma.AgentFindFirstArgs> = z.object({ select: AgentFindFirstSelectSchema.optional(), include: z.lazy(() => AgentIncludeObjectSchema.optional()), orderBy: z.union([AgentOrderByWithRelationInputObjectSchema, AgentOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgentWhereInputObjectSchema.optional(), cursor: AgentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgentScalarFieldEnumSchema, AgentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgentFindFirstArgs>;

export const AgentFindFirstZodSchema = z.object({ select: AgentFindFirstSelectSchema.optional(), include: z.lazy(() => AgentIncludeObjectSchema.optional()), orderBy: z.union([AgentOrderByWithRelationInputObjectSchema, AgentOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgentWhereInputObjectSchema.optional(), cursor: AgentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgentScalarFieldEnumSchema, AgentScalarFieldEnumSchema.array()]).optional() }).strict();