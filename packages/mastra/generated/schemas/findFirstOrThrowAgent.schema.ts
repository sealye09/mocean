...
export const AgentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AgentSelect> = z.object({
...
export const AgentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    prompt: z.boolean().optional(),
    type: z.boolean().optional(),
...
export const AgentFindFirstOrThrowSchema: z.ZodType<Prisma.AgentFindFirstOrThrowArgs> = z.object({ select: AgentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgentIncludeObjectSchema.optional()), orderBy: z.union([AgentOrderByWithRelationInputObjectSchema, AgentOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgentWhereInputObjectSchema.optional(), cursor: AgentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgentScalarFieldEnumSchema, AgentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AgentFindFirstOrThrowArgs>;

export const AgentFindFirstOrThrowZodSchema = z.object({ select: AgentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AgentIncludeObjectSchema.optional()), orderBy: z.union([AgentOrderByWithRelationInputObjectSchema, AgentOrderByWithRelationInputObjectSchema.array()]).optional(), where: AgentWhereInputObjectSchema.optional(), cursor: AgentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AgentScalarFieldEnumSchema, AgentScalarFieldEnumSchema.array()]).optional() }).strict();