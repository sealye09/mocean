...
export const TopicFindFirstSelectSchema: z.ZodType<Prisma.TopicSelect> = z.object({
...
export const TopicFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    prompt: z.boolean().optional(),
    pinned: z.boolean().optional(),
