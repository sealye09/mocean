...
export const FileTypeFindManySelectSchema: z.ZodType<Prisma.FileTypeSelect> = z.object({
...
export const FileTypeFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    origin_name: z.boolean().optional(),
    path: z.boolean().optional(),
...
export const FileTypeFindManySchema: z.ZodType<Prisma.FileTypeFindManyArgs> = z.object({ select: FileTypeFindManySelectSchema.optional(),  orderBy: z.union([FileTypeOrderByWithRelationInputObjectSchema, FileTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: FileTypeWhereInputObjectSchema.optional(), cursor: FileTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FileTypeScalarFieldEnumSchema, FileTypeScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.FileTypeFindManyArgs>;

export const FileTypeFindManyZodSchema = z.object({ select: FileTypeFindManySelectSchema.optional(),  orderBy: z.union([FileTypeOrderByWithRelationInputObjectSchema, FileTypeOrderByWithRelationInputObjectSchema.array()]).optional(), where: FileTypeWhereInputObjectSchema.optional(), cursor: FileTypeWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([FileTypeScalarFieldEnumSchema, FileTypeScalarFieldEnumSchema.array()]).optional() }).strict();