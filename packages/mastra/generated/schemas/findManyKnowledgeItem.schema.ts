...
export const KnowledgeItemFindManySelectSchema: z.ZodType<Prisma.KnowledgeItemSelect> = z.object({
...
export const KnowledgeItemFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    uniqueId: z.boolean().optional(),
    uniqueIdsJson: z.boolean().optional(),
    type: z.boolean().optional(),
