...
export const ModelProviderFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ModelProviderSelect> = z.object({
...
export const ModelProviderFindFirstOrThrowSelectZodSchema = z.object({
    model: z.boolean().optional(),
    modelId: z.boolean().optional(),
    provider: z.boolean().optional(),
    providerId: z.boolean().optional(),
...
export const ModelProviderFindFirstOrThrowSchema: z.ZodType<Prisma.ModelProviderFindFirstOrThrowArgs> = z.object({ select: ModelProviderFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ModelProviderIncludeObjectSchema.optional()), orderBy: z.union([ModelProviderOrderByWithRelationInputObjectSchema, ModelProviderOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelProviderWhereInputObjectSchema.optional(), cursor: ModelProviderWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelProviderScalarFieldEnumSchema, ModelProviderScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ModelProviderFindFirstOrThrowArgs>;

export const ModelProviderFindFirstOrThrowZodSchema = z.object({ select: ModelProviderFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ModelProviderIncludeObjectSchema.optional()), orderBy: z.union([ModelProviderOrderByWithRelationInputObjectSchema, ModelProviderOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelProviderWhereInputObjectSchema.optional(), cursor: ModelProviderWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelProviderScalarFieldEnumSchema, ModelProviderScalarFieldEnumSchema.array()]).optional() }).strict();