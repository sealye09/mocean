...
export const QuickPhraseFindFirstOrThrowSelectSchema: z.ZodType<Prisma.QuickPhraseSelect> = z.object({
...
export const QuickPhraseFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    title: z.boolean().optional(),
    content: z.boolean().optional(),
    order: z.boolean().optional(),
