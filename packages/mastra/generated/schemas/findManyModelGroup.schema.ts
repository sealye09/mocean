...
export const ModelGroupFindManySelectSchema: z.ZodType<Prisma.ModelGroupSelect> = z.object({
...
export const ModelGroupFindManySelectZodSchema = z.object({
    model: z.boolean().optional(),
    modelId: z.boolean().optional(),
    group: z.boolean().optional(),
    groupId: z.boolean().optional(),
...
export const ModelGroupFindManySchema: z.ZodType<Prisma.ModelGroupFindManyArgs> = z.object({ select: ModelGroupFindManySelectSchema.optional(), include: z.lazy(() => ModelGroupIncludeObjectSchema.optional()), orderBy: z.union([ModelGroupOrderByWithRelationInputObjectSchema, ModelGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelGroupWhereInputObjectSchema.optional(), cursor: ModelGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelGroupScalarFieldEnumSchema, ModelGroupScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ModelGroupFindManyArgs>;

export const ModelGroupFindManyZodSchema = z.object({ select: ModelGroupFindManySelectSchema.optional(), include: z.lazy(() => ModelGroupIncludeObjectSchema.optional()), orderBy: z.union([ModelGroupOrderByWithRelationInputObjectSchema, ModelGroupOrderByWithRelationInputObjectSchema.array()]).optional(), where: ModelGroupWhereInputObjectSchema.optional(), cursor: ModelGroupWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ModelGroupScalarFieldEnumSchema, ModelGroupScalarFieldEnumSchema.array()]).optional() }).strict();